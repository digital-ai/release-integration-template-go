...
[**Manage plugins**](#verify-the-plugin-is-installed), then create a template with
the **Container Examples: Hello (Go)** task (`goContainerExamples.Hello`) and run
it. Each step is detailed below.
